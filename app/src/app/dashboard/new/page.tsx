            ...
            {TEMPLATES.map(tpl => (
              <button
                ...
                style={{
                  ...
                  border: selectedTemplate === tpl.id ? "2px solid #4A5FD5" : "1.5px solid #E4E3DE",
              ...
              >
                ...
                <span style={{ fontSize: 13, fontWeight: 700, color: "#1C1C28" }}>{tpl.label}</span>
                <span style={{ fontSize: 11, color: "#7C7C8A", marginTop: 2 }}>{tpl.hint}</span>
              </button>
            ))}
          </div>
          <button
            ...
            style={{
              ...
              border: selectedTemplate === "MANUAL" ? "1.5px solid #4A5FD5" : "1.5px dashed #D0D7E8",
              borderRadius: 10, fontSize: 13, fontWeight: 600,
              color: selectedTemplate === "MANUAL" ? "#2563EB" : "#7C7C8A",
          ...
          <Section label="Due date *">
              ...
              {QUICK_DATES.map(qd => (
                <button
                  ...
                  style={{
                    ...
                    border: form.date === qd.value ? "none" : "1.5px solid #E4E3DE",
                    fontSize: 12, fontWeight: 600, cursor: "pointer",
                    background: form.date === qd.value ? "#4A5FD5" : "#fff",
                    color: form.date === qd.value ? "#fff" : "#7C7C8A",
            ...
            <div style={{ position: "relative" }}>
              <input
                ...
                required
                style={{ ...inputStyle, color: form.date ? "#1C1C28" : "#ACA9A3", paddingRight: 44 }}
              />
            ...
            <div style={{
              ...
              <button
                ...
                style={{
                  ...
                  fontSize: 13, fontWeight: 600, cursor: "pointer",
                  background: "transparent", color: "#7C7C8A",
          ...
          <div style={{ marginBottom: 24 }}>
            <button
              ...
              style={{
                ...
                border: showMoreDetails ? "1.5px solid #C0D8F8" : "1.5px solid #E4E3DE",
                fontSize: 14, fontWeight: 600,
                color: showMoreDetails ? "#2563EB" : "#7C7C8A",
                ...
                <Section label="Amount">
                  <div style={{ display: "flex", gap: 10 }}>
                    ...
                    <input
                      ...
                      value={form.currency}
                      readOnly
                      style={{ ...inputStyle, flex: 1, color: "#7C7C8A", cursor: "default" }}
                    />
                  </div>
                </Section>
          ...
          <div style={{ marginTop: 8 }}>
            <button
              ...
              style={{
                ...
                background: loading ? "#7C7C8A" : "#1C1C28",
