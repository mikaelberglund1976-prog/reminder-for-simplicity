...
function Section({ label, children }: { label: string; children: React.ReactNode }) {
  return (
    <div style={{ marginBottom: 24 }}>
      {label && <div style={{ fontSize: 15, fontWeight: 700, color: "#1C1C28", marginBottom: 10 }}>{label}</div>}
      {children}
    </div>
  );
}
...
const inputStyle: React.CSSProperties = {
  width: "100%", background: "#fff", border: "1.5px solid #E4E3DE", borderRadius: 14,
  padding: "13px 16px", fontSize: 15, color: "#1C1C28", outline: "none",
...
function pillStyle(active: boolean): React.CSSProperties {
  return {
    ...
    border: active ? "none" : "1.5px solid #E4E3DE", fontSize: 13, fontWeight: 600,
    cursor: "pointer", background: active ? "#4A5FD5" : "#fff",
    color: active ? "#fff" : "#7C7C8A", transition: "all 0.15s", fontFamily: FONT,
  };
}
    ...
    <div style={{ minHeight: "100vh", background: "#F5F4F0", fontFamily: FONT, paddingBottom: 40 }}>
      ...
      <main style={{ maxWidth: 480, margin: "0 auto", padding: "20px 20px 0" }}>
        ...
        <div style={{ marginBottom: 28 }}>
          ...
          <p style={{ fontSize: 14, color: "#7C7C8A", margin: "6px 0 0", lineHeight: 1.5 }}>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <Section label="Date *">
            <div style={{ position: "relative" }}>
              ...
              <div style={{ position: "absolute", right: 14, top: "50%", transform: "translateY(-50%)", color: "#7C7C8A", pointerEvents: "none" }}>
            ...
            <div style={{ display: "flex", gap: 0, background: "#ECEEF4", borderRadius: 50, padding: 3, width: "fit-content", alignItems: "center" }}>
              {allRec.map(rec => (
                <button key={rec.value} type="button" onClick={() => set("recurrence", rec.value)} style={{
                  ...
                  background: form.recurrence === rec.value ? "#4A5FD5" : "transparent",
                  color: form.recurrence === rec.value ? "#fff" : "#7C7C8A",
              ...
              <button type="button" onClick={() => setShowMoreRec(v => !v)} style={{
                ...
                cursor: "pointer", background: "transparent", color: "#7C7C8A",
          ...
          <Section label="Remind me">
            <div style={{ display: "flex", gap: 10 }}>
              ...
              <div style={{ position: "relative", width: 90 }}>
                ...
                <div style={{ position: "absolute", right: 10, top: "50%", transform: "translateY(-50%)", pointerEvents: "none", color: "#7C7C8A" }}>
          ...
          <Section label="Amount">
            <div style={{ display: "flex", gap: 10 }}>
              ...
              <input type="text" value={form.currency} readOnly style={{ ...inputStyle, flex: 1, color: "#7C7C8A", cursor: "default" }} />
            </div>
          </Section>
          ...
          <div style={{ marginTop: 8 }}>
            <button type="submit" disabled={saving} style={{
              ...
              fontSize: 16, fontWeight: 600, color: saving ? "#ACA9A3" : "#4A5FD5",
