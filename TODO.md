...
- [ ] **Kräver `npx prisma generate && npx prisma db push` lokalt** – additiv migrering (nya enum-värden + en ny kolumn), ingen backfill behövs.
